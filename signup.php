...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM nft_data where email= '$email'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            //success
            $succes = 1;
            $sql = "INSERT INTO nft_data(email,pass,names ) VALUES('$email','$password','$fullname')";
        ...
        <div class="container">
            <form method="post" autocomplete="on">
                ...
                <div class="box">
                    ...
                    <a href="signin.php" style="left: 54%;position: relative; text-decoration:none;color:#ff3002">Click to Login</a>
                </div>
